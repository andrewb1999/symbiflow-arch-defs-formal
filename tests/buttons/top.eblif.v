...
(* src = "/scratch/unsafe/butta/symbiflow-arch-defs/build/xc/xc7/tests/buttons/buttons_arty.v:1.1-8.10" *)
(* top =  1  *)
module top(clk, led, sw);
  (* src = "/scratch/unsafe/butta/symbiflow-arch-defs/build/xc/xc7/tests/buttons/buttons_arty.v:2.17-2.20" *)
  input clk;
  (* src = "/scratch/unsafe/butta/symbiflow-arch-defs/build/xc/xc7/tests/buttons/buttons_arty.v:5.23-5.26" *)
  output [7:0] led;
  (* src = "/scratch/unsafe/butta/symbiflow-arch-defs/build/xc/xc7/tests/buttons/buttons_arty.v:4.23-4.25" *)
  input [7:0] sw;
  assign led = sw;
endmodule
